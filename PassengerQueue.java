...
public class PassengerQueue 
{
		...
		/** The number of passengers served. */ private int numServed;
		/** The total time passengers were waiting. */ private int totalWait;
		...
		@param queueName The name of this queue */
		        ...
		        */
		        ...
		        public void setMaxProcessingTime(int x)
		        {
		        	maxProcessingTime = x;
		        }
		        ...
		        public void setArrivalRate(double num)
		        {
		        	arrivalRate = num/60;
		        }
